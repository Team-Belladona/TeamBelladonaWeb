---
title: "#2 Team Belladona: A New Beginning"
date: 2026-04-02
tags: elsewhere-en
layout: post-en.njk
---
...
Our team composition has changed. With various circumstances overlapping, we've reorganized — and now it's just Hyoni and Panthera, the two of us, building _Elsewhere_ together.

![Team Belladona](/assets/elsewhere/02/tung.png)

We'd be lying if we said there were no worries. Fewer people means more on each plate, no question. But when we actually sat down and talked it through, it felt like we could move _faster_ this way. Shorter decision-making loops, immediate feedback on each other's work, no lag between idea and action.
...
![Anne](/assets/elsewhere/02/anne.jpg)
...
![Ork Framework 3](/assets/elsewhere/02/ork3_logo.png)
...
![Anne in action](/assets/elsewhere/02/ork3_anne.gif)
...
Now that we have a build date locked in, time moves differently. There's a lot ahead for just two people — but somehow that's what keeps us focused. The characters are getting their stories, the code is getting attached, and Anne's footsteps are slowly beginning to cross the screen. The world of _Elsewhere_ is growing, bit by bit, but unmistakably.
