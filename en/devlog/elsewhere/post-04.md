...
![gesture1](/assets/elsewhere/04/gesture1.png)
![gesture2](/assets/elsewhere/04/gesture2.png)
![gesture3](/assets/elsewhere/04/gesture3.png)
...
![world](/assets/elsewhere/04/world.png)
...
![world](/assets/elsewhere/04/world.gif)
...
![style](/assets/elsewhere/04/style.png)
...
![speechbubble](/assets/elsewhere/04/speech_bubble.gif)
...
![normalattack](/assets/elsewhere/04/normal_attack.gif)

**Rapid Attack**: Mash the spacebar for two seconds to fill the timing bar.

![comboattack](/assets/elsewhere/04/combo_attack.gif)

**Charge Attack**: Hold the spacebar, then release it when the bar turns green.

![chargeattack](/assets/elsewhere/04/charge_attack.gif)
...
![yap_attack](/assets/elsewhere/04/yap_attack)
